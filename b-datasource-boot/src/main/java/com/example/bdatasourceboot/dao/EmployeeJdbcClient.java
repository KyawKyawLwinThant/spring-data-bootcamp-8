...
public class EmployeeJdbcClient {
    ...
    public void deleteById(int id){
        jdbcClient.sql("delete from employee where id =?")
                .param(1,id)
                .update();
    }
    ...
    public void create(Employee employee){
        jdbcClient.sql("""
                ...
                (?,?,?,?,?,?) 
                """)
                .params(List.of(employee.getFirstName(),
                        employee.getLastName(),
                        employee.getEmail(),
                        employee.getPhoneNumber(),
                        employee.getStartDate(),
    ...
    public Optional<Employee> findEmployeeByFirstNameAndLastName(String firstName,
                                                                 String lastName){
