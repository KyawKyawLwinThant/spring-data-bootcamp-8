...
public class EmployeeDao {
    ...
    public Employee highSalaryEmployee(){
        return jdbcTemplate
                .queryForObject("select * from employee order by salary desc limit 1",
                this::mapEmployee);
    }
    ...
    public double avgSalaryDatabaseLevel() {
        ...
        return jdbcTemplate.queryForObject("select avg(salary) from employee",
                Double.class);
    }
    ...
    public double avgSalaryRowCallBackHandler() {
        CustomRowCallBackHandler customRowCallBackHandler =
    ...
    public class CustomResultSetExtractor implements
            ResultSetExtractor<Double> {
        @Override
